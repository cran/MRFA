...
#'
#' @description The function extracts Bayesian information criterion (BIC) from a fitted MRFA model.
#'
#' @param fit a class MRFA object estimated by \code{MRFA_fit}.
#'
#' @return a vector with length \code{length(lambda)} returing BICs.
#'
